            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header">Stock Transfer Request Form.</h3>
                                    ...
                                    <div class="col-xs-12">
                                        <form class="form-horizontal" id="searchform" name="myForm" role="form" action="" method="POST" enctype="multipart/form-data">
                                            <div class="form-group" id="">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="form-control" name="retailer_id" id="retailer_id" onchange="getRetailerItem();" required="required">
                                                        <option value="">-- Select Retailer --</option>
                                                        <?php foreach (getAllRetailerData($_SESSION['id']) as $dataone) { ?>
                                                            <option value="<?php echo $dataone->id; ?>" <?php
                                                            if ($retailer_id == $dataone->id) {
                                                                echo 'selected="selected"';
                                                            }
                                                            ?>><?php echo $dataone->name; ?></option>
                                                                <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group" id="">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="form-control" name="item_id" id="item_id" required="required" onchange="get_available_stock();">
                                                        <?php
                                                        if (isset($_POST['retailer_id'])) {
                                            ...
                                            <div>
                                                <table id="dynamic-table" class="table table-bordered table-hover">
                                                    ...
                                                    <tfoot>
                                                        <?php if ($ind !== 0) { ?>
                                                            <tr>
                                                                <td colspan="5"><button class="btn btn-success btn-sm" onclick="confirmOrder(<?php echo $_SESSION['id'] ?>);">Confirm</button></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tfoot>
                                                </table>
