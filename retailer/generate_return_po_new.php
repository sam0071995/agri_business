...
$first_3char = substr(getRetailerById($_SESSION['id'])->name, 0, 3);

if ($fin_year_latest == '2425') {
    $text_poo = "PORET" . $_SESSION['id'] . "" . $fin_year_latest . "" . $po_no_increase;
} else {
    $text_poo = "PORET" . $first_3char . $b2b_prefix . $fin_year_latest . "" . $po_no_increase;
}
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        if (isset($_POST['btn_submit'])) {
                                            ...
                                            $data['generate_datetime'] = date('Y-m-d H:i:s');
                                            ...
                                            if ($reslt) {
                                                ...
                                                foreach ($get_cart_data as $cartdata) {
                                                    $current_stock = getCurrentStockByRetailerIdAndItemCode($_SESSION['id'], $cartdata->item_id);
                                                    $issued_stock = getIssuedStockByRetailerIdAndItemCode($_SESSION['id'], $cartdata->item_id);
                                                    ...
                                                    $itemsr_arr = array();
                                                    $itemsr_arr['status'] = 7;
                                                    $itemsr_arr['order_no'] = $_POST['txt_po_no'];
                                                    $itemsr_arr['update_datetime'] = date('Y-m-d H:i:s');
