...
if (isset($_POST['request_type'])) {
    if ($_POST['request_type'] == 'inward_reject') {
        ...
        if ($transferPending->dispatch_retailer_id != 0) {
            ...
            $whereitem_sr_master = "item_code='$transferPending->item_desc' AND retailer_id='$transferPending->dispatch_retailer_id' and batch_no='$transferPending->batch_number' and expire_date='" . date("Y-m-d", strtotime($transferPending->expire_date)) . "' and status='7'";
