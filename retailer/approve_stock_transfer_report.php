                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <h3 class="header-text"> Stock Transfer  Report.</h3>
                                            <div class="col-xs-12">
                                                <div class="row">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (count($getOrderRequest) > 0 && !empty($getOrderRequest)) {
                                                                    foreach ($getOrderRequest as $row) {
                                                                        ...
                                                                        if ($row->deleted == 1) {
                                                                            $status = '<b style="color:red;">Deleted By Central Team.</b>';
                                                                        }
                                                                        echo "<tr>"
                                                                        . "<td>" . $i . "</td>"
