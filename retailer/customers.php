                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <div class="row float-sm-left">
                                <a href="add_customer.php?menu=414" class="float-sm-left"><button class="btn btn-primary float-sm-left">New Customer</button></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $index = 1;
                                                $customer_data = getCustomerDetailsByRetailerId($_SESSION['id']);
