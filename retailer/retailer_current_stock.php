                                            ...
                                            <tbody>
                                                ...
                                                foreach ($products as $product) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank" href="retailer_current_free_sr_no.php?menu=<?php echo $menu; ?>&item=<?php echo base64_encode($product->item_code); ?>"><?php echo $product->current_stock; ?></a></td>
