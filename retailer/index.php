...
<html lang="en">
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <?php
            $notifications = getAdminproductNotifications($retailer_id);
            if ($notifications) {
                $index = 1;
                ?>
                <div id="myModalMsg_payment" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header"> 
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                <h2 style='text-transform: uppercase;color: #FFF;background-color: red;width: 80%;'>Important Notice</h2>
                            </div>
                            <div class="modal-body">
                                <P style="color: red;font-size:20px;">
                                    Dear Store In-Charge,<br/><br/>
                                    <?php foreach ($notifications as $notification) { ?>
                                        <?php echo $index++ . ") " . $notification->description; ?><br/>
                                        <?php if (!empty($notification->image)) { ?>
                                            <a href="<?php echo "http://agrosindia.in/centralOffice/" . $notification->image; ?>" target="_blank">View Document</a><br/><br/>
                                        <?php } ?>
                                    <?php } ?>
                                </p>
                            </div>
