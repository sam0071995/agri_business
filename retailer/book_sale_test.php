                                                ...
                                                <div class="form-group">
                                                    <?php if ($company_id == 3) { ?>
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="date" readonly="readonly" class="form-control invoice_date" name="invoice_date" value="<?php echo date("Y-m-d"); ?>">
                                                        </div>
                                                    <?php } else { ?>
                                            ...
                                            <div class="box-footer bg-gray">
                                                <table class="table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Customer Mobile : <input type="text" name="cus_ph" id="cus_ph" class="cus_ph" placeholder="Customer Mobile" /><br><br>
                        ...
                        if (filter.test(cus_ph)) {
                            if (cus_ph.length == 10) {
                                $.ajax({
                                    url: '<?php echo $ajax_page; ?>',
                                    type: 'POST',
                                    data: {cus_ph: cus_ph, request_type: "get_mobiledetails"},
                                    async: false,
                                    success: function (data) {
