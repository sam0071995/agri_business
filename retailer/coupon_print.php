...
if (isset($_GET['coupon_no'])) {
    $coupon_no = base64_decode($_GET['coupon_no']);
    $coupon_detail = getCouponDataByCouponNumber($coupon_no);
        ...
        <html lang="en">
            <head>
                ...
                <style>
                    ...
                    .scissor-icon {
                        position: absolute;
                        top: -10px;          /* move above line */
                        left: 50%;
                        transform: translateX(-50%);
                        background: #fff;    /* hides dashed line behind icon */
                        padding: 0 5px;
                        font-size: 16px;
                    }
                ...
                <div class="page-container">
                    ...
                    <div class="coupon-card">
                        ...
                        <div class="offer-details">
                            ...
                            <?php if ($coupon_detail->item_code != '0') { ?>
                                <p class="validity-text">On Item : <strong><?php echo $coupon_detail->item_code; ?></strong></p>
                            <?php } ?>
                        ...
                        <div class="executive-section">
                            ...
                            <div class="details-fields">
                                <div><span class="details-label">Coupon No.:</span> <br/><?php echo $coupon_detail->discount_code; ?></div>
                                <br/>
                                <div><span class="details-label">Seq:</span> <br/><?php echo getCompanypPrefixById($coupon_detail->company_id) . '-' . FiveDigit($coupon_detail->id); ?></div>
                            </div>
                        </div>
