...
$coupondata = getCouponDataByCoupon($a_row_master->coupon_code);
?>
...
<body onload="window.print();">
    <div class="row">
        ...
        <div class="right-div col-sm-8">
            <b style="font-size: 22px;">AGROS IMPLEX (I) PVT. LTD.</b>
            <font><b style="font-size: 20px;">Tax Invoice</b></font>
            <font style="font-size: 14px;"><?php echo 'B-6/2,GIDC ELECTRONIC ESTATE, SECTOR-25 ,GANDHINAGAR GANDHINAGAR Gandhinagar GJ 382024'; ?></font><br><br>
            <font style="font-size: 14px;text-align:left;">GSTIN Number : <?php echo '24AACCA5013C2ZI'; ?></font><br><br>
        </div>
        <div class="col-xs-12 col-sm-12">
            ...
            <table style="margin-top: 5% !important;">
                ...
                <tr>
                    <td style="text-align: left;">
                        ...
                        GSTIN Number : <?php echo $state_data->gstin_no; ?>
                    </td>
                </tr>
            </table>
            ...
            <table class="table" style="margin-top: 5% !important; width: 100% !important;" border="1">
                ...
                if ($a_row_master->coupon_code !== 0) {
                    print '<tr>
                            <td>Discount</td>
                            <td colspan="3"></td>
                            <td>' . $coupondata->price . '</td>
                        </tr>';
                    $a10 = $a10 - $coupondata->price;
                }
                print '<tr style="font-size: 12px !important;">
            ...
            <table style="margin-top: 5% !important; width: 100% !important;">
                <tr>
                    <td class="left top">
                        CIN : U51909GJ1998PTC113363<br />
                        PAN No : AACCA5013C<br />
                    </td>
