                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <?php } ?>
                                <h3 class="page-header">Villages Details.</h3>
                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $index = 1;
                                                $villages = getVillages($retailer_id);
                                                foreach ($villages as $village) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="add_village.php?menu=28&village_id=<?php echo base64_encode($village->id); ?>"><button class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $index++;
