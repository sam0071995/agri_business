                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header-text">Physical Audit Record Entry Report.</h3><a href="physical_audit_record_entry.php?menu=449"><button class="btn btn-danger">Entry Form</button></a>
                                        <hr/>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="row">
                                                        ...
                                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                                            <thead class="thead-dark">
                                                                <tr>
                                                                    ...
                                                                    <th width="15%" align="left">Audit Date</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (isset($_POST['show'])) {
                                                                    ...
                                                                    $purchaseOrder = get_data_of_physical_audit_table($date_1, $date_2, $_SESSION['id']);
