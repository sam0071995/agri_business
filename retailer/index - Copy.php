            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    $(".total_cash").blur(function () {
                        ...
                        var total_money_currency = parseInt($(".2000_total_money").val()) + parseInt($(".500_total_money").val()) + parseInt($(".200_total_money").val()) + parseInt($(".100_total_money").val()) + parseInt($(".50_total_money").val()) + parseInt($(".20_total_money").val()) + parseInt($(".10_total_money").val());
