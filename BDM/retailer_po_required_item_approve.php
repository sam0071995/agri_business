...
if (in_array($bdm_id, $teratory_manager_id)) {
    echo "<script>location.href='retailer_po_required_item_approve_ttm.php?menu=404';</script>";
    exit;
}
?>
<!DOCTYPE html>
                                                        ...
                                                        <div>
                                                            <table id="dynamic-table" class="table table-bordered table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $where = "status = '1' and date(added_time) >= '$from_date' and date(added_time) <= '$to_date'";
                                                                    if ($Retailer_id == 0) {
