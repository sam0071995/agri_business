                                    ...
                                    <div class="page-header">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">Pre Purchase Goods Order</h4>
                                            </div>
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    <form class="form-inline center" name="po_form_one" action="" method="POST">
                                                        <div class="row">
                                                            <div class="form-group">
                                                                <div class="col-xs-14">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        if (isset($_REQUEST['date_1'])) {
                                                                            echo $_REQUEST['date_1'];
                                                                        } else {
                                                                            echo date('d-m-Y');
                                                                        }
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-xs-14">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    if (isset($_REQUEST['date_2'])) {
                                                                        echo $_REQUEST['date_2'];
                                                                    } else {
                                                                        echo date('d-m-Y');
                                                                    }
                                                                ?>" data-date-format="dd-mm-yyyy" />
                                            ...
                                            <table id="dynamic-table" class="table table-bordered table-hover">
                                                <thead class="thead-dark">
                                                    <tr>
                                                        ...
                                                        <th width="40%" align="left">Invoice</th>
                                                        <th width="40%" align="left">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    if (isset($_REQUEST['date_1']) && isset($_REQUEST['date_2'])) {
                                                        $date_1 = date("Y-m-d", strtotime($_REQUEST['date_1']));
                                                        $date_2 = date("Y-m-d", strtotime($_REQUEST['date_2']));
                                                        $status = 0;
                                                        $i = 1;
                                                        $where = '';
                                                        ...
                                                        if ($_SESSION['admin_flag'] == 1) {
                                                            $where .= "date(po_date) between '$date_1' and '$date_2' and company_id in ($companyidd)";
                                                        } else {
                                                            $where .= "date(po_date) between '$date_1' and '$date_2' and user_id ='$useridd'";
                                                        }
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="40%" style="white-space: nowrap;">
                                                                        ...
                                                                        foreach ($Pdetails as $Pdetail) {
                                                                            ...
                                                                            for ($l = 0; $l < count($rateilar_string); $l++) {
                                                                                if ($rateilar_string[$l] != $tmp_name_store) {
                                                                                    echo $index . ". " . getRetailerNameById($rateilar_string[$l]) . ' <br/>';
                                                                                    $index++;
                                                                                }
                                                                                $tmp_name_store = $rateilar_string[$l];
                                                                            }
                                                                    ...
                                                                    <td >
                                                                        <select name="status_val" id="status_val_<?php echo $i; ?>" >
                                                                            ...
                                                                            <option value="4" <?php echo ($row->status == 4) ? "selected='selected'" : ''; ?>>Material Pending</option>
                                                                            <option value="5" <?php echo ($row->status == 5) ? "selected='selected'" : ''; ?>>Po Cancelled</option>
                                                                        </select>
                                                                        <br>
                                                                        <br>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if ($row->invoice_flag == 1) {
                                                                            ?>
                                                                            <a target='_blank' href='http://agrosindia.in/retailer/<?php echo $row->invoice_upload; ?>'><?php echo $row->upload_invoice_no; ?></a>
                                                                            <?
                                                                        } else {
                                                                            ?>
    ...
    function UpdateCurrentStatus(idd, ponoo) {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                window.location.href = "purchase_order_for_basic.php?menu=425&date_1="+date_1+"&date_2="+date_2;
            }
        });
    }
