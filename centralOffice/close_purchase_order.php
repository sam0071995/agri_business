        ...
        <div class="main-container ace-save-state" id="main-container">
                                            ...
                                            <div>
                                                <table id="dynamic-table" class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $status = 2;
                                                        $i = 1;
                                                        $purchaseOrder = getClosedPurchaseOrderListByStatus($status);
                                                        if (count($purchaseOrder) > 0) {
                                                            foreach ($purchaseOrder as $row) {
                                                                ...
                                                                . "<td>"
                                                                .
                                                                "<a href='generate_new_po_edit.php?menu=11&purchase_id=" . base64_encode($row->id) . "'><button type='button' class='btn-success' style='cursor:pointer' title='Click to Edit'>Edit</button></a>" .
                                                                "<a target='_blank' href='inventory_purchase_report.php?po_no=" . base64_encode($row->po_no) . "'><button type='button' class='btn-warning' style='cursor:pointer' title='Click to Print'>Print</button></a></td></tr>";
                                                                $i++;
                                                            }
                                                        } else { 
                                                            ?>
                                                            <tr><td style="text-align: center;color: red;" colspan="6">Records Not Found.</td></tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                            </div>
            ...
            <script type="text/javascript">
                ...
                function released_purchase_click() {
                    window.location.href = "release_purchase_order_list.php";
                }
                ...
                function show_detail()
                {
                    ...
                    if (vendor_id_ajit != '') {
                        var xmlhttp;
                        var url = "ajax_tape.php?type=vendor&id=" + vendor_id_ajit;
                ...
                function item_unit()
                {
                    ...
                    var xmlhttp;
                    var url = "ajax_tape.php?type=itemunit&id=" + res[0];
