                                            ...
                                            <div class="widget-main">
                                                <form class="form-inline center" action="" method="POST">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-xs-3">
                                                            <select class="form-control" style="text-align: left;" multiple name="item_code[]" id="item_code">
                                                                <?php foreach (getActiveItemsListForPriceUpdate() as $active_item) { ?>
                                                                    <option value="<?php echo $active_item->item_code; ?>"><?php echo $active_item->item_desc; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="clearfix form-actions">
                                                        <div class="col-md-offset-3 col-md-5">
                                                            <button class="btn btn-info" type="submit" name="show1" value="show">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_POST['show1'])) {
                                                    ...
                                                    if (isset($_POST['item_code'])) {
                                                        $item_code_aray = $_POST['item_code'];
                                                    } else {
                                                        print '<script>alert("Select Items");window.location="product_wise_sales_report.php' . $menuURL . '";</script>';
                                                        exit;
                                                    }
                                                    $retailer_id_string = "'";
                                                    ...
                                                    $item_code_string = "'";
                                                    $item_code_string .= implode("','", $item_code_aray);
                                                    $item_code_string .= "'";

                                                    $index = 1;
                                                    $products = getProductSalesByRetailerTempTableIN($date_1, $date_2, $retailer_id_string, $item_code_string, $company_id_in);
