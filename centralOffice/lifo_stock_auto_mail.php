...
//            $activeItems = getRetailerActivesbYItems($retailer_id, $item_code);
            ...
            foreach ($activeItems as $activeItem) {
                ...
                $opening_puirchase_fifo = getRetailerStockTInwardFifoPurchaseGSTFifo($retailer_id, $item_code, $previous_date);
                ...
                $store_in_purchase_fifo = getRetailerStockTInwardForDatePOMailBetweenFifoPurchaseFifo($retailer_id, $item_code, $date_1, $date_2);
                if (!isset($store_in_purchase_fifo->po_basic)) {
                    $store_in_purchase_fifo = getRetailerStockTRANSFERInwardForDatePOMailBetweenFifoPurchaseFifo($retailer_id, $item_code, $date_1, $date_2);
                }
                ...
                if ($last_po_basic == 0) {
                    $store_in_purchase_whatever = getCompanyRetailerStockTInwardForDatePOMailBetweenFifoPurchaseWhateverFifo($retailer_company_id, $item_code, $date_1, $date_2);
                    if (!isset($store_in_purchase_whatever->po_basic)) {
                        $store_in_purchase_whatever = getRetailerStockTInwardForDatePOMailBetweenFifoPurchaseWhateverFifo($retailer_id, $item_code, $date_1, $date_2);
                    }
        ...
        header("Content-Disposition: attachment; filename=LIFO_stock_details-" . $date_1 . "-to-" . $date_2 . ".xls");
