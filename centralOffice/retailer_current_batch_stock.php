                                            ...
                                            <tbody>
                                                ...
                                                foreach ($products as $product) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank" href="retailer_current_free_sr_no.php?retailer_id=<?php echo base64_encode($product->retailer_id); ?>&menu=<?php echo "38"; ?>&item=<?php echo base64_encode($product->item_code); ?>"><?php echo getFreeItemsSrByitemBatchCount($product->retailer_id, $product->item_code); ?></a></td>
