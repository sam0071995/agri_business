                            ...
                            <div class="col-xs-12">
                                                                ...
                                                                <div class="input-group">
                                                                    <select class="form-control" name="user_id">
                                                                        ...
                                                                        <?php foreach (getActiveRetailerDetails($company_id_in) as $active_sellers) { ?>
                                                                            ...
                                                                            if ($active_sellers->id == $post_user_id) {
                                ...
                                <div class="modal-body">
                                    ...
                                    if (isset($_POST['show'])) {
                                        ...
                                        if (!empty($user_id)) {
                                            $user_data = getRetailerById($user_id);
                                            $assign_menu_string = $user_data->menu;
                                            $assign_menu_array = explode(',', $assign_menu_string);
                                            ?>
                                            <h3>Change Assign menu for user : <b class="red"><?php echo $user_data->full_name; ?></b></h3>
                                            <form action="" method="post">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <?php
                                                        $forms_menu_lists = getRetailerSubMenuList(2);
                                                        $index = 0;
                                                    ...
                                                    <tr>
                                                        <?php
                                                        $forms_menu_lists = getRetailerSubMenuList(3);
                                                        $index = 0;
                                                        foreach ($forms_menu_lists as $forms_menu_list) {
                                                            if ($index % 4 == 0) {
                                                                echo "</tr><tr>";
                                    ...
                                    if (isset($_POST['update_menu'])) {
                                        ...
                                        $update_menu_string = "13,1,2,3," . $update_menu_string;
                                        $data = array();
                                        $data['menu'] = $update_menu_string;
                                        $where = "id='$user_id'";
                                        $update = update("retailer_master", $data, $where);
                                        if ($update) {
                                            print '<script>alert("Menus Successfully Assign.");window.location="retailer_assign_menu.php' . $menuURL . '&success=1";</script>';
                                            exit;
                                        } else {
                                            print '<script>alert("Sorry, something Wrong.");window.location="retailer_assign_menu.php' . $menuURL . '&error=1";</script>';
                                            exit;
                                        }
                                    }
                                    ?>
