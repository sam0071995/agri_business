...
function validateGSTIN($gstin)
{
    ...
    $codePointChars = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    $factor = 2;
    $sum = 0;

    for ($i = 13; $i >= 0; $i--) {
        $digit = strpos($codePointChars, $gstin[$i]);
        $addend = $factor * $digit;

        $factor = ($factor == 2) ? 1 : 2;
        $addend = floor($addend / 36) + ($addend % 36);
        $sum += $addend;
    }

    $remainder = $sum % 36;
    $checkCodePoint = (36 - $remainder) % 36;
    $expectedCheckChar = $codePointChars[$checkCodePoint];
...
function getInwardDataByRetailerIdFilterJoinReportInventoryGRN($date_1, $date_2, $retailer_id, $company_id_in, $status_filter, $item_code, $status_report)
{
    ...
    $tbl_fields = "company_id,po_type,vendor_id,dispatch_retailer_id,inward_qty as billed_qty,retailer_inwd_flg,retailer_id,item_desc,invoice_date,batch_number AS batch_number,po_no,po_date,date_time,supplier_name,po_no,po_no,bill_no,item_desc,expire_date,manufacture_date AS manufacture_date,retailer_inwd_date,po_basic,po_gst,po_discount,Vehicle_Number,inward_Vehicle_Number,inward_name_of_person";
    $table_name = "inventory_grn";
    ...
    $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = 'po_no,item_desc,batch_number,expire_date,date(retailer_inwd_date)', $asc = 1, $desc = '', $limit = '');
    return $result;
}
...
function getPurchaseOrderListByStatusReturnPoDate($retailer_id, $date1, $date2)
{
    $tbl_fields = "a.status as status,a.po_no,a.po_date,a.supplier_id,a.retailer_id,a.grand_total,b.item_id,b.qty,b.rate,b.gst_rate,b.gst_amount,b.amount,b.batch_no,a.po_type as po_type";
    $table_name = "purchase_order_return a , purchase_order_return_detail b";
    $where = "a.id=b.id and  a.retailer_id in ($retailer_id) AND b.status NOT IN ('7') AND b.delete='0' and date(a.po_date) between '$date1' and '$date2'";
    $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = 0, $limit = '');
    return $result;
}
...
function getPoDetailsByPoUniqueId($po_unique_id)
{
    $tbl_fields = "*";
    $table_name = "purchase_order_detail";
...
function getGroupPONOListByUserId()
{
    $tbl_fields = "id,po_no,retailer_id,po_date,vendor_id,po_type";
    $table_name = "purchase_order";
    $where = "status in ('0','1','2') and company_id in (" . $_SESSION['company_id'] . ")";
    $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = 'po_no', $order_by = '', $asc = '0', $desc = '0', $limit = '');
    return $result;
}
...
function getPurchaseOrderDetailsBySum($purchase_id)
{
    $tbl_fields = "sum(amount) as amount,sum(gst_amount) as gst_amount";
    $table_name = "purchase_order_detail";
    $where = "id='$purchase_id'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = 'id', $asc = 0, $desc = 0, $limit = '');
    return $result;
}
...
function getPurchaseOrderNumberByPOId($poId)
{
    $tbl_fields = "po_no";
    $table_name = "purchase_order";
    $where = "id='$poId'";
...
{
    $tbl_fields = "retailer_inwd_flg,retailer_inwd_date,po_basic,po_gst";
    $table_name = "inventory_grn";
...
{
    $tbl_fields = "id,retailer_inwd_flg,retailer_id,retailer_inwd_date,inward_qty,po_no,bill_no,dispatch_retailer_id,supplier_name,po_basic,po_gst";
    $table_name = "inventory_grn";
...
{
    $tbl_fields = "retailer_inwd_flg,retailer_id,retailer_inwd_date,inward_qty,po_no,bill_no,dispatch_retailer_id,supplier_name,po_basic,po_gst";
    $table_name = "inventory_grn";
...
function getInwardedBalanceQtyInoiceNo($retailer_id, $order_no, $item_code)
{
    $tbl_fields = "billed_qty";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' AND po_no='$order_no' and item_desc='$item_code'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
...
function getProductSalesByRetailerItemCodeTempTable($f_date, $l_date, $Retailer_id, $company_id_in, $item_code)
{
    ...
    $tbl_fields = "m.`retailer_id` AS retailer_id,m.company_id,m.added_datetime as added_datetime,m.order_no as order_no,t.price as total_price,m.discount_amount,m.coupon_code,t.basic,m.total_count as total_count,m.fin_year AS fin_year,t.item_code as item_code,t.item_name as item_name,t.qty as qty,t.uom as uom,m.payment_type,m.transaction_no,t.cgst_rate,t.sgst_rate,t.cgst as cgst,t.sgst as sgst,t.basic as basic ,m.added_date as added_date,t.batch_no,m.cus_name,m.cus_add,m.cus_ph,m.cus_adhar,m.cus_village,m.cus_pin,m.b2b_flg,m.gstin_no,t.credit_note_no,t.return_qty,m.gstin_no as gstin_no";
    $table_name = "retailer_order_master m, retailer_order_temporary t";
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
}
...
function getProductSalesByRetailerItemCodeTempTableAllInnerJoin($f_date, $l_date, $Retailer_id, $company_id_in, $item_code)
{
    $where_q = "";
    if ($Retailer_id != "All") {
        $where_q = " AND m.`retailer_id`='$Retailer_id'";
    }
    $tbl_fields = "m.retailer_id,m.company_id,m.added_datetime,m.order_no,t.price AS total_price,t.basic,m.total_count,m.discount_amount,m.coupon_code,m.fin_year,t.item_code,t.item_name,t.qty,t.uom,m.payment_type,m.transaction_no,t.cgst_rate,t.sgst_rate,t.cgst,t.sgst,m.added_date,t.batch_no,m.cus_name,m.cus_add,m.cus_ph,m.cus_adhar,m.cus_village,m.cus_pin,m.b2b_flg,m.gstin_no,t.credit_note_no,t.return_qty";
    $table_name = "retailer_order_master m INNER JOIN retailer_order_temporary t ON m.order_no = t.po_no";
    $where = "m.added_date >= '$f_date 00:00:00' AND m.added_date <= '$l_date 23:59:59' AND m.status NOT IN ('7','8') AND m.company_id in ($company_id_in)" . $where_q;
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
}
...
//     }
//     $tbl_fields = "t.main_category,t.sub_category,m.`retailer_id` AS retailer_id,m.added_datetime as added_datetime,m.order_no as order_no,t.price as total_price,m.discount_amount,m.coupon_code,m.total_count as total_count,m.fin_year AS fin_year,t.item_code as item_code,t.item_name as item_name,t.qty as qty,t.uom as uom,m.payment_type,m.transaction_no,t.cgst_rate,t.sgst_rate,t.cgst as cgst,t.sgst as sgst,t.basic as basic ,m.added_date as added_date,t.batch_no,m.cus_name,m.cus_add,m.cus_ph,m.cus_adhar,m.cus_village,m.cus_pin,m.b2b_flg,m.gstin_no,t.credit_note_no,t.return_qty";
//     $table_name = "retailer_order_master m, retailer_order_temporary t";
...
function getProductSalesByRetailerTempTableCatIN($f_date, $l_date, $retailer_id_string, $company_id_in, $cat_id)
{
    ...
    $where = "m.`added_date` BETWEEN '$f_date 00:00:00' AND '$l_date 23:59:59'
              AND m.`order_no` = t.`po_no`
              AND m.`status` NOT IN ('7','8')
              AND m.`company_id` IN ($company_id_in)
              $cat_string";

    $table_name = "retailer_order_master m 
                   INNER JOIN retailer_order_temporary t 
                   ON m.order_no = t.po_no

                   LEFT JOIN retailer_master r 
                   ON r.id = m.retailer_id

                   LEFT JOIN inventory_master im 
                   ON im.item_code = t.item_code

                   LEFT JOIN categories c1 
                   ON c1.id = t.main_category
                   
                   LEFT JOIN categories c2 
                   ON c2.id = t.sub_category";

    $tbl_fields = "t.main_category,
                   t.sub_category,
                   c1.name AS main_category_name,
                   c2.name AS sub_category_name,
                   m.retailer_id AS retailer_id,
...
function getProductSalesByRetailerTempTableCatINReject($f_date, $l_date, $retailer_id_string, $company_id_in, $cat_id)
{
    $cat_string = "";
    if (!empty($cat_id)) {
        $cat_string = " AND t.`main_category`='$cat_id'";
    ...
    $tbl_fields = "t.main_category,t.sub_category,m.`retailer_id` AS retailer_id,m.added_datetime as added_datetime,m.order_no as order_no,t.price as total_price,m.total_count as total_count,m.fin_year AS fin_year,t.item_code as item_code,t.item_name as item_name,t.qty as qty,t.uom as uom,m.payment_type,m.transaction_no,t.cgst_rate,t.sgst_rate,t.cgst as cgst,t.sgst as sgst,t.basic as basic ,m.added_date as added_date,t.batch_no,m.cus_name,m.cus_add,m.cus_ph,m.cus_adhar,m.cus_village,m.cus_pin,m.b2b_flg,m.gstin_no,t.credit_note_no,t.return_qty";
    $table_name = "retailer_order_master m, retailer_order_temporary t";
    $where = "DATE(m.added_date) BETWEEN '$f_date' AND '$l_date' AND m.`order_no`=t.`po_no` AND m.status in ('7','8') and m.company_id in ($company_id_in)" . $cat_string;
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
}
...
function getRetailerPurchaseforProfibilityDate($Retailer_id, $company_id_in, $date_1, $date_2)
{
    $where_q = "";
    if ($Retailer_id != "All") {
        $where_q = " AND `retailer_id`='$Retailer_id'";
    ...
    $tbl_fields = "retailer_id,SUM(po_basic * inward_qty) AS purchase";
    $table_name = "inventory_grn";
    $where = "retailer_inwd_flg = '1'and po_type not in ('2') AND DATE(retailer_inwd_date) between '$date_1' and '$date_2' and company_id in ($company_id_in)" . $where_q;
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = 'retailer_id', $order_by = '', $asc = 0, $desc = '', $limit = '');
}

function getRetailerPurchaseforProfibilityDateOpening($Retailer_id, $company_id_in, $date_1, $date_2)
{
    $where_q = "";
    $tbl_fields = "retailer_id,SUM(po_basic * inward_qty) AS purchase";
    $table_name = "inventory_grn";
    $where = "retailer_inwd_flg = '1' and po_type not in ('2') and retailer_id='$Retailer_id' AND DATE(retailer_inwd_date) between '$date_1' and '$date_2' and company_id in ($company_id_in)" . $where_q;
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
...
function getRetailerReturnSalesProfibilityDate($retailer_id, $date_1, $date_2)
{
    $tbl_fields = "sum(po_basic) as return_item_value";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and po_type='2' and dispatch_retailer_id=0 and retailer_inwd_flg = '1' and status not in ('7')  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    if (isset($result->return_item_value)) {
        return $result->return_item_value;
    } else {
...
function getRetailerReturnPurchaseProfibilityDate($retail_id, $date_1, $date_2)
{
    $tbl_fields = "SUM(pd.amount) AS amount";
    $table_name = "`purchase_order_return` p,`purchase_order_return_detail` pd";
    $where = "p.`retailer_id`='$retail_id' AND pd.status not in ('7','8')  AND pd.`delete`='0' AND DATE(p.`po_date`) between '$date_1' and '$date_2' AND p.`id`=pd.`id`";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    if (isset($result->amount)) {
        return $result->amount;
    } else {
...
function getProductSalesBy_IN_RetailerTempTableWiseCat($f_date, $l_date, $retailer_id_string, $company_id_in, $category_id)
{
    ...
    $tbl_fields = "m.`retailer_id` AS retailer_id,m.added_datetime as added_datetime,m.order_no as order_no,sum(t.price) as total_price,sum(m.discount_amount) as discount_amount,SUM(t.basic) AS basic,SUM(sgst) AS sgst,SUM(cgst) AS cgst,m.total_count as total_count,m.fin_year AS fin_year,t.item_code as item_code,t.item_name as item_name,t.qty as qty,t.uom as uom,m.payment_type,m.transaction_no,m.added_date as added_date,m.gstin_no as gstin_no";
    $table_name = "retailer_order_master m, retailer_order_temporary t";
    $where = "DATE(m.added_date) BETWEEN '$f_date' AND '$l_date' $where_q AND m.`order_no`=t.`po_no` AND m.status not in ('7','8') and m.company_id in ($company_id_in)";
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = 'm.`retailer_id`', $order_by = '', $asc = 0, $desc = '', $limit = '');
}
...
function getProductSalesBasicAmtByRetailerTempTable($f_date, $l_date, $Retailer_id, $company_id_in)
{
    $where_q = "";
    if ($Retailer_id != "All") {
        $where_q = " AND m.`retailer_id`='$Retailer_id'";
    }
    $tbl_fields = "sum(t.basic) as totalFinal";
    $table_name = "retailer_order_master m, retailer_order_temporary t";
    $where = "DATE(m.added_date) BETWEEN '$f_date' AND '$l_date' $where_q AND m.`order_no`=t.`po_no` AND m.status not in ('7','8') and m.company_id in ($company_id_in)";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
    return $result->totalFinal;
...
function getRetailerStockTInwardAvarage($retailer_id, $item_code, $previous_date)
{
    $tbl_fields = "count(id) as countId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic,po_gst";
    $table_name = "inventory_grn";
    //    $where = "retailer_id='$retailer_id' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '2021-04-01' and '$previous_date'";
    $where = "retailer_id='$retailer_id' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '2021-04-01' and '$previous_date'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
...
function getRetailerStockTInwardFifoPurchaseGSTFifo($retailer_id, $item_code, $previous_date)
{
    $tbl_fields = "po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '2021-04-01' and '$previous_date'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = 'id', $asc = '1', $desc = '0', $limit = '1');
    return $result;
}
...
function getBackendRetailerStockTInwardAvarage($retailer_id, $item_code)
{
    $tbl_fields = "count(id) as countId,SUM(current_stock) AS qty,sum(purchae_basic) as purchae_basic,purchase_gst,sum(purchase_total) as purchase_total";
    $table_name = "item_inward_backend";
    //    $where = "retailer_id='$retailer_id' AND item_code='$item_code' AND DATE(update_datetime)='2023-07-01'";
    $where = "retailer_id='$retailer_id' AND item_code='$item_code' and status='1' AND DATE(update_datetime)='2023-07-01'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
...
function getBackendRetailerStockTInwardValueRetaikerMasterDate($retailer_id)
{
    $tbl_fields = "opening";
    $table_name = "retailer_master";
    $where = "id='$retailer_id'";
...
{
    $tbl_fields = "sum(total_basic) as total_basic,count(pd.id) as count,SUM(pd.`qty`) AS qty,sum(pd.amount) as amount,sum(pd.rate) as rate,sum(pd.gst_rate) as gst_rate,pd.rate as po_rate,pd.gst_rate as po_gst_rate,pd.retailer_id,p.vendor_id as vendor_id,p.po_no";
    $table_name = "`purchase_order_return` p,`purchase_order_return_detail` pd";
...
function getRetailerTransferPurchareonDateMailBetweenAvarage($retail_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "count(pd.id) as countId,SUM(pd.`qty`) AS qty,sum(pd.amount) as total_basic";
    $table_name = "`purchase_order_return` p,`purchase_order_return_detail` pd";
    $where = "p.`retailer_id`='$retail_id' AND pd.`item_id`='$item_code' AND DATE(p.`po_date`) between '$date_1' and '$date_2' AND p.`id`=pd.`id` AND pd.delete='0' and pd.status not in ('7')";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    return $result;
...
function getRetailerStockTransferonDateMailBetweenAvaraage($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "count(id) as countId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "dispatch_retailer_id='$retailer_id' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2'";
...
function getRetailerStockTInwardForDateMailBetweenAvarage($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "count(id) as coutId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and dispatch_retailer_id!='0' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    return $result;
...
function getRetailerStockTInwardForDatePOMailBetweenFifoPurchaseFifo($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and dispatch_retailer_id='0' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2' and po_basic>0";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = 'id', $asc = '1', $desc = '', $limit = '1');
    return $result;
}
...
function getRetailerStockTRANSFERInwardForDatePOMailBetweenFifoPurchaseFifo($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and dispatch_retailer_id!='0' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2' and po_basic>0";
...
function getRetailerStockTInwardForDatePOMailBetweenFifoPurchaseWhateverFifo($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "retailer_inwd_flg = '1' and item_desc='$item_code' AND po_basic>0";
...
function getCompanyRetailerStockTInwardForDatePOMailBetweenFifoPurchaseWhateverFifo($retailer_company_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "po_basic,po_gst";
    $table_name = "inventory_grn";
    $where = "company_id='$retailer_company_id' and retailer_inwd_flg = '1' and item_desc='$item_code' AND po_basic>0";
...
function getRetailerStockTInwardForDatePOMailBetweenAvarage($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "count(id) as countId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and po_type not in ('2') and dispatch_retailer_id=0 and retailer_inwd_flg = '1' and status not in ('7') and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    return $result;
...
function getRetailerStockTInwardForDateCreditNoteMailBetweenAvarage($retailer_id, $item_code, $date_1, $date_2)
{
    $tbl_fields = "count(id) as countId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic";
    $table_name = "inventory_grn";
    $where = "retailer_id='$retailer_id' and po_type='2' and dispatch_retailer_id=0 and retailer_inwd_flg = '1' and status not in ('7') and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '$date_1' and '$date_2'";
...
function getRetailerTransferPurchareAvarage($retail_id, $item_code, $date_1)
{
    $tbl_fields = "SUM(pd.`qty`) AS qty,sum(amount) as amount";
    $table_name = "`purchase_order_return` p,`purchase_order_return_detail` pd";
    $where = "p.`retailer_id`='$retail_id' AND pd.`item_id`='$item_code' AND DATE(p.`po_date`) between '2021-04-01' and '$date_1' AND p.`id`=pd.`id` AND pd.delete='0' and pd.status not in ('7')";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    return $result;
...
function getRetailerStockTransferAvarage($retailer_id, $item_code, $date_1)
{
    $tbl_fields = "count(id) as countId,SUM(inward_qty) AS inward_qty,sum(po_basic) as po_basic";
    $table_name = "inventory_grn";
    $where = "dispatch_retailer_id='$retailer_id' and retailer_inwd_flg = '1' and item_desc='$item_code'  AND DATE(retailer_inwd_date) between '2021-04-01' and '$date_1'";
...
{
    $tbl_fields = "SUM(qty) AS qty,sum(return_qty) as return_qty";
    $table_name = "retailer_order_temporary";
...
function getRetailerSalesDetailAvarage($retail_id, $item_code, $date_1)
{
    $tbl_fields = "SUM(qty) AS qty,sum(return_qty),sum(basic) as basic";
    $table_name = "retailer_order_temporary";
    $where = "retailer_id='$retail_id' AND item_code='$item_code' AND STATUS NOT IN ('7','8') AND DATE(order_place_date) between '2021-04-01' and '$date_1'";
    $result = mysql_select($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = '', $desc = '', $limit = '');
    return $result;
...
function getAdminproductProductBrand()
{
    $tbl_fields = "*";
...
function getActiveproductProductBrand()
{
    $tbl_fields = "id,name,status";
    $table_name = "`product_brands`";
    $where = "status='1'";
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
}

function getActiveproductTechnicalName()
{
    $tbl_fields = "id,name,status";
    $table_name = "`product_technical_name`";
    $where = "status='1'";
    return $result = mysql_selects($tbl_fields, $table_name, $where, $group_by = '', $order_by = '', $asc = 0, $desc = '', $limit = '');
}

function getAdminproductTechnicalName()
{
    $tbl_fields = "*";
    $table_name = "`product_technical_name`";
    $where = "";
...
function getTechnicalNameById($brand_id)
{
    $tbl_fields = "*";
    $table_name = "product_technical_name";
    $where = "id='$brand_id'";
...
function getAdminProductBrandsById($brand_id)
{
    $tbl_fields = "*";
    $table_name = "`product_brands`";
    $where = "id='$brand_id'";
