...
if (isset($_POST['submit'])) {
    ...
    if ($update) {
        header("Location:villages.php" . $menuURL . "&success=1");
        exit;
    } else {
        header("Location:villages.php" . $menuURL . "&error=1");
        exit;
    }
}
?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" id="searchform" name="myForm"  role="form" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" id="c_n_password_c">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Select District<span style="color:red">*</span> : </label>
                                        <div class="col-sm-6">
                                            <select class="form-field-select-2 form-control" name="retailer_id">
