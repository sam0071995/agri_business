                    ...
                    <div class="coupon-card">
                        ...
                        <div class="executive-section">
                            ...
                            <div class="details-fields">
                                <div><span class="details-label">Coupon No.:</span> 
                                    <br/><?php echo $coupon_detail->discount_code; ?></div>
                                <div><span class="details-label">Seq:</span> 
                                    <br/><?php echo getCompanypPrefixById($coupon_detail->company_id) . '-' . FiveDigit($coupon_detail->id); ?></div>
                            </div>
                        </div>
