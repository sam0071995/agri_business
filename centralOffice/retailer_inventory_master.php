                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $index = 1;
                                                $products = getRetailerItemByRetailerIdItemIdAll($retailer_id, $item_code, $company_id_in);
                                                foreach ($products as $product) {
                                                    ...
                                                    $totalSalesCount = getSalesIemQtyQty($product->item_code, $product->retailer_id);
                                                    $StockINBackend = getInwardedBackEndItemQty($product->item_code, $product->retailer_id);
                                                    $StockIN = getInwardedItemQty($product->item_code, $product->retailer_id);
                                                    $StockTransfer = getDispatchedItemQty($product->item_code, $product->retailer_id);
                                                    $returnPO = getRetailerReturnPO($product->item_code, $product->retailer_id);
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b class="cyan">StockIN-IT : <?php echo $StockINBackend; ?></b><br/>
                                                            <b class="cyan">StockIN : <?php echo $StockIN; ?></b><br/>
                                                            <b class="blue">Sales : <?php echo $totalSalesCount; ?></b><br/>
                                                            <b class="blue">SalesTransfer : <?php echo $StockTransfer; ?></b><br/>
                                                            <b class="blue">ReturnPO : <?php echo $returnPO; ?></b><br/>
