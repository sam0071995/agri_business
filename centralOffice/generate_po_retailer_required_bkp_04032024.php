...
//                                            exit;
                                            ...
                                            if ($reslt) {
                                                ...
                                                echo '<script>alert("PO Saved");window.location.href="generate_po_retailer_required_bkp.php?menu=402&success=1";</script>';
                                            } else {
                                                echo '<script>window.location.href="generate_po_retailer_required_bkp.php?menu=402&error=1";</script>';
                                            }
                                        }
                                        ?>
                                        <div>
                                            <form class="form-horizontal" method="post" action="" id="pur_entry">
                                                <input type="hidden" name="company_id_in" id="company_id_in" value="<?php echo $company_id_in; ?>" />
                                                <table align="center" border="0" width="100%" bgcolor="#E5FFEB" bordercolor="#000000">
                                                    <tr>
                                                        <td colspan="4" align="center"><i>
                                                                <font color="#336633" size="+3">Purchase Goods Order As Retailer Requested. ( Multiple Retailer )</font>
                                                            </i></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr align="center">
                                                        <th align="left">P.O. No. <br>
                                                            ...
                                                            echo "AGRO" . $_SESSION['id'] . "" . $fin_year_latest . "" . $po_no_increase;
                                                            ?>">
                                                            <b class="red"><?php
                                                                echo "AGRO" . $_SESSION['id'] . "" . $fin_year_latest . "" . $po_no_increase;
                                                                ?></b>
                                                        ...
                                                        <th align="left">Retailer Name <br>
                                                            <select class="text" name="Retailer_id" id="Retailer_id"  required="required">
                                                    ...
                                                    <tr>
                                                        <th  >Item<br>
                                                            <select class="chosen-selec" name="txt_item" id="txt_item" onchange="item_unit()" style="height:30px;width:300px;">
                                                                ...
                                                                <?php
                                                                foreach (getRequiredItemPoListByCompanyId($company_id_in) as $row) {
...
//                                                                
                                                        ...
                                                        <th id="retailer_item_html">Retailer <br/>
                                                            <select name="retailer_for_item[]" multiple="" id="retailer_for_item" >
...
<!--                                                    <tr>
            ...
            <script type="text/javascript">
                ...
                function getPoItemList() {
                    var company_id_in = document.getElementById('company_id_in').value;
                    $.ajax({
                        url: 'ajax_agro.php?menu=1',
                        method: 'post',
                        data: {types: 'get_retailer_po_item_company', company_id_in: company_id_in},
...
//                            alert(reslt);
                ...
                function item_unit()
                {
                    ...
                    var company_id = document.getElementById('company_id_in').value;
                    $('#retailer_item_html').html('');

                    $.ajax({
                        url: 'ajax_agro.php?menu=1',
                        method: 'post',
                        data: {types: 'get_item_data_by_companyid', itemcode: itemcode, company_id: company_id},
                        success: function (reslt) {
//                            console.log(reslt);
                            var parsedata = JSON.parse(reslt);
                            $('#retailer_item_html').html(parsedata.html);
                            $('#retailer_for_item').multiselect();
                ...
                function showCartItems() {
                    $.ajax({
                        ...
                        method: 'post',
                        data: {request_type: 'get_cart_items_data_company'},
                ...
                function addCartIteam() {
                    if (document.getElementById("txt_item").value != "")
                    {
                        ...
                        } else if (Number(document.getElementById("txt_price").value) == 0)
                        {
                            ...
                            var retailer_id_item = $('#retailer_for_item').val();
                            retailer_id_item.toString();
//                            console.log(retailer_id_item);

                            $.ajax({
                                url: 'ajax_agro.php?menu=11',
                                method: 'post',
                                data: {request_type: 'add_po_cart_item_by_company', retailerid: retailerid, po_number: po_number, item_code: item_code, item_qty: item_qty, unit_price: unit_price, gst_rate: gst_rate, gst_amt: gst_amt, net_amt: net_amt, txt_dis_unitprice: txt_dis_unitprice, retailer_id_item: retailer_id_item},
                                success: function (resp) {
//                                    console.log(resp);
//                                    return false;
                                    showCartItems();
                ...
                function delete_cart_data(idd, itemcode, retailer_string, added_date) {
                    ...
                    $.ajax({
                        url: 'ajax_agro.php?menu=11',
                        method: 'post',
                        data: {request_type: 'delete_cart_po_data_company', idd: idd, item_code: itemcode, retailerid: retailerid, po_number: po_number, retailer_string: retailer_string, added_date: added_date},
                        success: function (resp) {
                            if (resp == 0) {
