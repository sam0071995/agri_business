                                                        ...
                                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                                            <thead class="thead-dark">
                                                                <tr>
                                                                    ...
                                                                    <th width="15%" align="left">Ref Id</th>
                                                                    ...
                                                                    <th width="15%" align="left">Inward Qty</th>
                                                                    ...
                                                                    <th width="15%" align="left">BatchStatus</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php
                                                                if (isset($_POST['show'])) {
                                                                    ...
                                                                    $status = 0;
                                                                    $i = 1;
                                                                    $purchaseOrder = getInwardDataByDates($date_1, $date_2, $company_id_in, $retailer_id);
                                                                    foreach ($purchaseOrder as $row) {
                                                                        ...
                                                                        $batch_grn_qty = getItemSrMasterDataByGrnIDCount($row->id);

                                                                        if (decimalToINT($purchase_qty) == decimalToINT($batch_grn_qty)) {
                                                                            $statusbatch = "OK";
                                                                        } else {
                                                                            $statusbatch = "IssueWithBatch";
                                                                        }
                                                                        ?>
                                                                        <tr>
                                                                            <td><?php echo $i; ?></td>
