                                                    ...
                                                    <div>
                                                        <table id="dynamic-table" class="table table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $status = 0;
                                                                $i = 1;
                                                                $getOrderRequest = getApproveStockRequest();
                                                                if (count($getOrderRequest) > 0 && !empty($getOrderRequest)) {
                                                                    foreach ($getOrderRequest as $row) {
                                                                        ...
                                                                        . "<td width='300'>";
                                                                        ?>
                                                                    <button type='button' onclick="approveRequestOrder(<?php echo $row->id; ?>);" class='button btn-success' style='cursor:pointer' title='Inward'>Approve</button>&nbsp;&nbsp;&nbsp;
                ...
                function approveRequestOrder(order_item_id)
                {
                    if (confirm("Are you sure you want to approve this item?")) {
                        $.ajax({
                            ...
                            data: {'types': 'approveRequest', 'order_item_id': order_item_id},
                            success: function (result) {
                                result = $.trim(result);
                                if (result == 1) {
