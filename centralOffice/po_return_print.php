...
require_once 'includes/po_print_function.php';
$bdd = new db();
...
$company_detail = $bdd->getCompanyDetailById($retailer_data->company_id);
...
if ($bdd->purchaseOrderByidCount($orderId) > 0) {
    ...
    <html>
        <head>
            ...
            <script>
                var print_page = function myFunction() {
                    window.print();
                }();
            </script>
        </head>
        <body>
            <div class="container">
                ...
                <div class="header-title">
                    <h5><u>RETURN PURCHASE ORDER</u></h5>
                </div>
                <div class="left">
                    To, <br />
                    ...
                    <b> Supplier GSTIN No : <?php
                        echo $bdd->getVendorGstinNoById($orderData->vendor_id);
                        ?> </b> <br />
                </div>
                <div class="right">
                        ...
                        <tbody>
                            ...
                            foreach ($orderDetails as $orderDetail) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $orderDetail->batch_no; ?></td>
                            ...
                            <tr>
                                <td rowspan="5" colspan="3" align="left" style="padding: 3px; margin: 0;vertical-align: top;"><b>Remarks : </b> <?php echo $orderData->remarks; ?></td>
                                <td colspan="">P & F</td>
                                <td>N.A</td>
                            ...
                            <tr>
                                ...
                                <td colspan="8" align="left" class="term_condition">
                                    <b>
                                        Material should be dispatched at M/s <?php echo $orderData->supplier_name; ?>,<?php echo $orderData->supplier_address; ?> Contact Person : <?php echo $orderData->supplier_contact_person; ?> (<?php echo $orderData->supplier_contact_no; ?>)
                                    </b>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>8</td>
                                <td colspan="8" align="left"><b>Terms of Delivery: <?php echo $orderData->term_delivery; ?></b></td>
                            </tr>
                            <tr>
                                <td>9</td>
