                                ...
                                <div class="page-header">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title">Retailer | Product wise Sales <b class="red">Reject</b> Report.</h4>
                                        </div>
...
//echo $retailer_id_string;
//exit;
                                                    $products = getProductSalesByRetailerTempTableCatINReject($date_1, $date_2, $retailer_id_string, $company_id_in, $category_id);
...
//                                                        $item_detail = getproductDetailsByCode($product->item_code);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo getCategoryNameById($product->main_category); ?></td>
                                                            <td><?php echo getCategoryNameById($product->sub_category); ?></td>
