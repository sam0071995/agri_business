...
//                                            exit;
                                            ...
                                            if ($reslt) {
                                                ...
                                                $grnupwhr = "po_no = '" . $orderData->po_no . "'";
                                                update('inventory_grn', $insertData, $grnupwhr);

                                                $item_sr_arr = array();
                                                $item_sr_arr['vendor_id'] = $orderData->vendor_id;
...
//                                                 $upd_arr = array();
//                                                $upd_arr['status'] = 1;
//                                                $whrr = "id='$pur_id' and user_id = '" . $_SESSION['id'] . "'";
...
<!--                                                        <th>Delivery Date<br>
                                                            <input type="date" id="delivry_date" name="delivry_date" size="6" class="text">
                                                        </th>-->
                                                    </tr>
                                                    <tr>
                                                        <th align="left"><br>
                                                ...
                                                <table align="center" border="0" width="100%" bgcolor="#E5FFEB" bordercolor="#000000" style="margin-top:1%">
                                                    <tr>
                                                        ...
                                                        <th>GSTTotal<br>
                                                            <input type="text" id="txt_tot_gst" readonly="readonly" name="txt_tot_gst" value="<?php
                                                            if (isset($x_id))
                                                                echo $r4->sgst_amt;
                                                            else
                                                                echo "0";
                                                        ...
                                                        <th>Discount<br>
                                                            <input type="text" id="txt_discount" name="txt_discount" value="<?php
                                                            if (isset($x_id))
                                                                echo $r4->discount;
                                                            else
                                                                echo "0";
                                                            ?>" onchange="cal_net_amt()" style="text-align:center; width:55%; height:30px">
                                                        </th>
                                                        <th>Grand Total<br>
...
//                    return false;
                    $.ajax({
                        ...
                        method: 'post',
                        data: {request_type: 'get_cart_items_data_update', pur_id: pur_id},
                    ...
                    if (document.getElementById("txt_item").value != "")
                    {
                        ...
                        } else if (Number(document.getElementById("txt_price").value) < 0)
                        {
                            ...
                            $.ajax({
                                url: 'ajax_agro.php?menu=11',
                                method: 'post',
                                data: {request_type: 'add_po_cart_item_update', pur_id: pur_id, item_code: item_code, item_qty: item_qty, unit_price: unit_price, gst_rate: gst_rate, gst_amt: gst_amt, net_amt: net_amt},
                                success: function (resp) {
                                    showCartItems();
...
//                    return false;
                    $.ajax({
                        url: 'ajax_agro.php?menu=11',
                        method: 'post',
                        data: {request_type: 'delete_cart_po_data', idd: idd},
                        success: function (resp) {
                            if (resp == 0) {
