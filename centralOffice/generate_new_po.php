                                                ...
                                                <table align="center" border="0" width="100%" bgcolor="#E5FFEB" bordercolor="#000000">
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <th align="left">Retailer Name <br>
                                                            <select class="chosen-select text" name="Retailer_id" id="Retailer_id" required="required">
                                                    ...
                                                    <tr>
                                                        <th  colspan="3" align="left">PO Reference<br>
                                                            <select class="chosen-select text" name="po_reference" id="po_reference" required="required">
                                                                <option value="0">--select reference--</option>
                                                                <?php foreach (getPurchaseOrderReferenceList($_SESSION['company_id']) as $PurchaseOrderReference) { ?>
                                                                    <option value="<?php echo $PurchaseOrderReference->po_no; ?>">
                                                                        <?php echo $PurchaseOrderReference->po_no . " | " . $PurchaseOrderReference->supplier_name . " | " . getRetailerNameById($PurchaseOrderReference->retailer_string); ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                        </th>
                                                        <th align="left">Supplier Name <br>
                                                            <select name="txt_vendor" id="txt_vendor" class="chosen-select text" onchange="getVendorDetails();">
